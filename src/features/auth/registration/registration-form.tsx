...
export function RegistrationForm({
  ...
  return (
    <form action={formAction} className="mt-7" data-testid="register-form">
      ...
      <p
        className="mt-5 text-xs leading-5 text-muted-gray"
        data-testid="register-resend-helper"
      >
        If a pending registration already exists, submitting again sends another
        verification email only when the rate limit allows it.
      </p>
